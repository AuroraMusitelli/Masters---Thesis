...
remove_seasonality <- function(y, freq = 12) {     
...
## Funzione per estrarre la componente ciclica con HPJ 
...
dataCO2_cycle <- as.data.frame(dataCO2_cycle)
dataENERGY_cycle <- as.data.frame(dataENERGY_cycle)


saveRDS(dataCO2_cycle,   "dataCO2_cycle.rds")
saveRDS(dataENERGY_cycle, "dataENERGY_cycle.rds")
